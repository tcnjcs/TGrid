 ...
 * @author Dan
 */
public class JacobsthalTask extends Task {
     ...
     * 
     * @param id a (preferrably) unique number for the task, used primarily as a visual aid
     */
    public JacobsthalTask(int[] commandLineArguments) {
        commandToRun = new String[1+commandLineArguments.length];
        commandToRun[0] = "./primeprog";
